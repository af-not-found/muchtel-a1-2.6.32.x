...
static const camera_size_type picture_sizes[] = {
    // { 2592, 1944 }, 5MP, not supported on ov5642af
...
static SensorType sensorTypes[] = {
        ...
        { "5mp", 2592, 1944, true,  2592, 1944,0x00000fff },  // for ov5642af
...
void QualcommCameraHardware::filterPreviewSizes(){
    ...
    if (!strcmp(mSensorInfo.name, "ov5642af"))
        boardMask = 0xff;
...
void QualcommCameraHardware::initDefaultParameters()
{
    ...
    if( (!strcmp(sensorType->name, "2mp")) ||
        (!strcmp(mSensorInfo.name, "vx6953")) ||
		(!strcmp(mSensorInfo.name, "ov5642af")) ||
		(!strcmp(mSensorInfo.name, "VX6953")) ) {
...
{
    if(!strcmp(sensorType->name, "2mp") || !strcmp(mSensorInfo.name, "ov5642af")) {
